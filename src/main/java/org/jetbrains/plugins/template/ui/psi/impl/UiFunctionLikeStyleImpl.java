...
public class UiFunctionLikeStyleImpl extends ASTWrapperPsiElement implements UiFunctionLikeStyle {

  public UiFunctionLikeStyleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UiVisitor visitor) {
    visitor.visitFunctionLikeStyle(this);
  }
  ...
  public UiPropertyValue getPropertyValue() {
    return findNotNullChildByClass(UiPropertyValue.class);
  }
