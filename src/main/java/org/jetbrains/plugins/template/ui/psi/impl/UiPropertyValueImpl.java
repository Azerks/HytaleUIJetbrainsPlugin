...
public class UiPropertyValueImpl extends ASTWrapperPsiElement implements UiPropertyValue {

  public UiPropertyValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public UiPropertyList getPropertyList() {
    return findChildByClass(UiPropertyList.class);
  }
