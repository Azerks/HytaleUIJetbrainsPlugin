...
public class UiComponentDefinitionImpl extends ASTWrapperPsiElement implements UiComponentDefinition {

  public UiComponentDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public UiComponentBody getComponentBody() {
    return findNotNullChildByClass(UiComponentBody.class);
  }

  @Override
  @NotNull
  public UiComponentReference getComponentReference() {
    return findNotNullChildByClass(UiComponentReference.class);
  }
