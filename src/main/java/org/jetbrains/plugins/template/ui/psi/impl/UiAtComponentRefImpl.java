...
public class UiAtComponentRefImpl extends ASTWrapperPsiElement implements UiAtComponentRef {

  public UiAtComponentRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UiVisitor visitor) {
    visitor.visitAtComponentRef(this);
  }
