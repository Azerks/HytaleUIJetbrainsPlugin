...
public class UiAtPropertyOverrideImpl extends ASTWrapperPsiElement implements UiAtPropertyOverride {

  public UiAtPropertyOverrideImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UiVisitor visitor) {
    visitor.visitAtPropertyOverride(this);
  }
