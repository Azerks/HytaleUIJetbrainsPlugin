...
public class UiMathPropertyListImpl extends ASTWrapperPsiElement implements UiMathPropertyList {

  public UiMathPropertyListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull UiVisitor visitor) {
    visitor.visitMathPropertyList(this);
  }
